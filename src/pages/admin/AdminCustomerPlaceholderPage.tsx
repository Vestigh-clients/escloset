...
const AdminCustomerPlaceholderPage = () => {
  ...
  return (
    <div className="admin-page">
      ...
      <h1 className="admin-page-title mt-2 font-display text-[32px] italic text-[#1A1A1A]">Customer {id}</h1>
      <p className="mt-3 font-body text-[12px] text-[#555555]">Customer detail management can be added in the next pass.</p>
      <Link
        to="/admin/orders"
