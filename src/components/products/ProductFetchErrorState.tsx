...
const ProductFetchErrorState = ({ title = "Could not load products." }: ProductFetchErrorStateProps) => {
  return (
    <div className="flex min-h-[320px] flex-col items-center justify-center px-6 py-16 text-center">
      <AlertCircle size={24} strokeWidth={1.25} className="text-[#aaa]" />
      <p className="mt-4 font-display text-[22px] italic text-[#888888]">{title}</p>
      <p className="mt-2 font-body text-[12px] text-[#aaa]">Please refresh the page to try again.</p>
      <button
        type="button"
