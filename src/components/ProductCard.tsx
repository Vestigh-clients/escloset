...
const ProductCard = ({ product }: ProductCardProps) => {
  ...
  return (
    <div className="group bg-card rounded-[var(--border-radius)] overflow-hidden transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-[0_12px_28px_rgba(var(--color-navbar-solid-foreground-rgb),0.12)]">
